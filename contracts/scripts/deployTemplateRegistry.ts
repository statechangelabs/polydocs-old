...
async function main() {
  ...
  const addTemplate_1 = await doc.add({"name":"Contributor Covenant Code of Conduct","cid":"bafkreifixnauyla72v2axblfn6qxy5i5i4jgy7ucwwnhllhdqoj3y22k6a", "score":0, "MetadataURI":"bafkreic3l2gzpnmdlhsby3qvnpi7b5dn4schpjcbuabslnw4znykcpmema", "owner":"0xF7fF442a8184E113476b68F5d2cFEE57ad1ae6DE"}); 
  ...
  const getTemplate_2 = await doc.template(0);
